...
export function RicePage() {
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="【農薬不使用の安心】無農薬ヒノヒカリ お取り寄せ通販 | 産地直送"
        description="除草剤や農薬を一切使用せず、12種類の有機質肥料のみで栽培した安心・安全なお米。無農薬で強く美味しいお米をつける稲を育てることにこだわり、産地から直送でお届け。玄米・白米・7分づき米をお選びいただけます。"
        keywords="無農薬米 お取り寄せ,ヒノヒカリ 通販,無農薬栽培,有機栽培米,産地直送,安心安全な米,玄米,白米,7分づき米,健康米,オーガニック米,自然栽培,美味しいお米"
