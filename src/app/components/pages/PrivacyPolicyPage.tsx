...
export function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="プライバシーポリシー"
        description="つるいちご園のプライバシーポリシーをご確認ください。"
        url="/privacy-policy"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8" style={{ background: 'linear-gradient(135deg, var(--color-strawberry-100) 0%, var(--color-strawberry-200) 100%)', border: '1px solid var(--color-strawberry-300)' }}>
              <Shield className="w-4 h-4" style={{ color: 'var(--color-strawberry-700)' }} />
              <span className="text-sm font-medium" style={{ color: 'var(--color-strawberry-800)', fontFamily: 'var(--font-sans)', letterSpacing: '0.05em' }}>Privacy Policy</span>
            </div>
