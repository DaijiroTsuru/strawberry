...
import { fetchProductById, ShopifyProduct, formatPrice } from '@/utils/shopify';
 ...
 * 
 * 使用方法:
 * <ProductDetailPage productId="gid://shopify/Product/123456789" />
 * 
 * このコンポーネントは:
 * 1. productIdからShopify商品データを取得
 * 2. カスタムデザインで商品詳細を表示
 * 3. variantIdを使ってカートに追加
 */
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl" style={{ color: 'var(--color-neutral-600)' }}>
            商品が見つかりませんでした
          </p>
          <a
            href="/strawberries"
