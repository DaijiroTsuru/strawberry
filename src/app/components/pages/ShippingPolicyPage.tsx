...
export function ShippingPolicyPage() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="配送ポリシー"
        description="つるいちご園の配送に関するポリシーをご確認ください。"
        url="/shipping-policy"
        structuredData={createBreadcrumbSchema([
          { name: 'ホーム', url: '/' },
          { name: '配送ポリシー', url: '/shipping-policy' },
        ])}
      />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8" style={{ background: 'linear-gradient(135deg, var(--color-strawberry-100) 0%, var(--color-strawberry-200) 100%)', border: '1px solid var(--color-strawberry-300)' }}>
              <Truck className="w-4 h-4" style={{ color: 'var(--color-strawberry-700)' }} />
              <span className="text-sm font-medium" style={{ color: 'var(--color-strawberry-800)', fontFamily: 'var(--font-sans)', letterSpacing: '0.05em' }}>Shipping Policy</span>
            </div>
